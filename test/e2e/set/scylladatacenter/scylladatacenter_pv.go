...
var _ = g.Describe("ScyllaDatacenter Orphaned PV", func() {
	...
	g.It("should replace a node with orphaned PV", func() {
		...
		sd, err = utils.WaitForScyllaDatacenterState(waitCtx3, f.ScyllaClient().ScyllaV1alpha1(), sd.Namespace, sd.Name, utils.WaitForStateOptions{}, func(sc *scyllav1.ScyllaDatacenter) (bool, error) {
