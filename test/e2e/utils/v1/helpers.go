...
func GetStatefulSetsForScyllaCluster(ctx context.Context, client appv1client.AppsV1Interface, sd *scyllav1alpha1.ScyllaDatacenter) (map[string]*appsv1.StatefulSet, error) {
