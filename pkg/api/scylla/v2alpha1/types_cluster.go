...
const (
	...
	RackConditionTypeAvailable           = "Available"
	RackConditionTypeProgressing         = "Progressing"
	RackConditionTypeDegraded            = "Degraded"
)

const (
	DatacenterConditionTypeDatacenterUpgrading       = "DatacenterUpgrading"
	DatacenterConditionTypeDatacenterDecommissioning = "DatacenterDecommissioning"
	DatacenterConditionTypeAvailable                 = "Available"
	DatacenterConditionTypeProgressing               = "Progressing"
	DatacenterConditionTypeDegraded                  = "Degraded"
)
