...
func (in *NodeConfigNodeStatus) DeepCopyInto(out *NodeConfigNodeStatus) {
	*out = *in
	...
	if in.RaidsCreated != nil {
		in, out := &in.RaidsCreated, &out.RaidsCreated
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.FilesystemsCreated != nil {
		in, out := &in.FilesystemsCreated, &out.FilesystemsCreated
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.MountsCreated != nil {
		in, out := &in.MountsCreated, &out.MountsCreated
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RegexDevice) DeepCopyInto(out *RegexDevice) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RegexDevice.
func (in *RegexDevice) DeepCopy() *RegexDevice {
	if in == nil {
		return nil
	}
	out := new(RegexDevice)
