...
func (c *ScyllaV1alpha1Client) ScyllaDatacenters(namespace string) ScyllaDatacenterInterface {
	return newScyllaDatacenters(c, namespace)
}
...
// NewForConfigAndClient creates a new ScyllaV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ScyllaV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
