...
type ServiceMonitorInformer interface {
	...
	Lister() v1alpha1.ServiceMonitorLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IntegreatlyV1alpha1().ServiceMonitors(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IntegreatlyV1alpha1().ServiceMonitors(namespace).Watch(context.TODO(), options)
			},
		},
		&integreatlyv1alpha1.ServiceMonitor{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceMonitorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&integreatlyv1alpha1.ServiceMonitor{}, f.defaultInformer)
}

func (f *serviceMonitorInformer) Lister() v1alpha1.ServiceMonitorLister {
	return v1alpha1.NewServiceMonitorLister(f.Informer().GetIndexer())
}
