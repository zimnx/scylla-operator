...
var grafanasResource = schema.GroupVersionResource{Group: "integreatly.org", Version: "v1alpha1", Resource: "grafanas"}

var grafanasKind = schema.GroupVersionKind{Group: "integreatly.org", Version: "v1alpha1", Kind: "Grafana"}
