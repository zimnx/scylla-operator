...
func PerftuneConfigMap(snc *scyllav1alpha1.NodeConfig, scyllaPod *corev1.Pod, data []byte) *corev1.ConfigMap {
	cm := &corev1.ConfigMap{
		ObjectMeta: metav1.ObjectMeta{
...
func PerftuneJob(snc *scyllav1alpha1.NodeConfig, nodeName, image, ifaceName, irqMask string, dataHostPaths []string, disableWritebackCache bool) *batchv1.Job {
	args := []string{
